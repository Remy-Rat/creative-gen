# IG-AD-01 — build brief

*GLAMRDiP Instant Gels · structure from the Doonails teardown · original copy · hero shade **Bubbly Babe** · ~40s · 20 beats*

Captions: white sans, top, line-by-line fade. Sound: upbeat electronic, duck under VO, buzzer/ding. VO: AUS GM (eleven_v3).

| # | Phase | Time | VO | Caption (style) | SFX | Clip / B-ROLL |
|--|--|--|--|--|--|--|
| 1 | HOOK | 0.0-1.3s | I gave up on press-ons years ago. | I gave up on press-ons _(SUB-02 clean reader)_ | — | Ruby Rush_Flowers.MOV (Ruby Rush, hooks) |
| 2 | HOOK | 1.3-2.3s | Too fake. Too bulky. | too fake. too bulky. _(SUB-03 kinetic)_ | — | Ruby Rush_Cat.MOV (Ruby Rush, hooks) |
| 3 | HOOK | 2.3-3.7s | Then these changed my mind. | then these changed my mind _(SUB-04 karaoke (hl: changed my mind))_ | — | Bubbly Babe_9.MOV (Bubbly Babe, posing_lifestyle) |
| 4 | PROBLEM | 3.7-5.9s | You know the type — | you know the type _(SUB-02 clean reader)_ | — | ⚠️ B-ROLL: Faceless macro: a thick, bulky generic plastic press-on sitt |
| 5 | PROBLEM | 5.9-7.7s | thick plastic that just sits on top. | thick plastic _(ANN-03 sticker + red ✗)_ | buzzer | ⚠️ B-ROLL: Faceless macro: side angle showing a chunky press-on's gap/l |
| 6 | PROBLEM | 7.7-9.5s | Gaps at the cuticle. | gaps at the cuticle _(ANN-02 leader callout + red ✗)_ | — | ⚠️ B-ROLL: Faceless extreme-macro: visible gap/lifting under a press-on |
